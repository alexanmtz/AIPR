...
def request_changes_from_openai(filename, context):
    response = openai.Completion.create(
        ...
        #prompt="Giving the filename:'" + filename  + "' and the following content:" + context + "\ntitle:" + issue_title + "issue:" + question,
        prompt="Given the filename '" + filename  + "' and the existing content below, provide a solution, considering the existing content, for the following issue:" + question + ".\n\nFilename: " + filename + "\nContent:\n" context,
